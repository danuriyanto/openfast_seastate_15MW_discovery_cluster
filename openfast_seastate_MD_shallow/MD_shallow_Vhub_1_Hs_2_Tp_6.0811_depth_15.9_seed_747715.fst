	------- OpenFAST INPUT FILE -------------------------------------------	
IEA 15 MW offshore reference model monopile configuration _Vhub_1_Hs_2_Tp_6.0811_depth_15.9_seed_747715
---------------------- SIMULATION CONTROL --------------------------------------	
...
---------------------- INPUT FILES ---------------------------------------------	
MD_shallow_Vhub_1_Hs_2_Tp_6.0811_depth_15.9_seed_747715.ElastoDyn.Inp	  EDFile      - Name of file containing ElastoDyn input parameters (quoted string)	
...
"MD_shallow_Vhub_1_Hs_2_Tp_6.0811_depth_15.9_seed_747715.Inflow.Inp"     InflowFile  - Name of file containing inflow wind input parameters (quoted string)	
"MD_shallow_Vhub_1_Hs_2_Tp_6.0811_depth_15.9_seed_747715.AeroDyn.Inp"	  AeroFile    - Name of file containing aerodynamic input parameters (quoted string)	
"MD_shallow_Vhub_1_Hs_2_Tp_6.0811_depth_15.9_seed_747715.ServoDyn.Inp"	   ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)	
"MD_shallow_Vhub_1_Hs_2_Tp_6.0811_depth_15.9_seed_747715.SeaState.Inp"   SeaStFile     - Name of file containing sea state input parameters (-)
"MD_shallow_Vhub_1_Hs_2_Tp_6.0811_depth_15.9_seed_747715.HydroDyn.Inp"	   HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)	
"MD_shallow_Vhub_1_Hs_2_Tp_6.0811_depth_15.9_seed_747715.SubDyn.Inp"	     SubFile     - Name of file containing sub-structural input parameters (quoted string)	
