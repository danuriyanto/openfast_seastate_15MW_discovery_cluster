	------- OpenFAST INPUT FILE -------------------------------------------	
IEA 15 MW offshore reference model monopile configuration _Vhub_33_Hs_3.5_Tp_8.0446_depth_15.9_seed_567725
---------------------- SIMULATION CONTROL --------------------------------------	
...
---------------------- INPUT FILES ---------------------------------------------	
MD_shallow_Vhub_33_Hs_3.5_Tp_8.0446_depth_15.9_seed_567725.ElastoDyn.Inp	  EDFile      - Name of file containing ElastoDyn input parameters (quoted string)	
...
"MD_shallow_Vhub_33_Hs_3.5_Tp_8.0446_depth_15.9_seed_567725.Inflow.Inp"     InflowFile  - Name of file containing inflow wind input parameters (quoted string)	
"MD_shallow_Vhub_33_Hs_3.5_Tp_8.0446_depth_15.9_seed_567725.AeroDyn.Inp"	  AeroFile    - Name of file containing aerodynamic input parameters (quoted string)	
"MD_shallow_Vhub_33_Hs_3.5_Tp_8.0446_depth_15.9_seed_567725.ServoDyn.Inp"	   ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)	
"MD_shallow_Vhub_33_Hs_3.5_Tp_8.0446_depth_15.9_seed_567725.SeaState.Inp"   SeaStFile     - Name of file containing sea state input parameters (-)
"MD_shallow_Vhub_33_Hs_3.5_Tp_8.0446_depth_15.9_seed_567725.HydroDyn.Inp"	   HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)	
"MD_shallow_Vhub_33_Hs_3.5_Tp_8.0446_depth_15.9_seed_567725.SubDyn.Inp"	     SubFile     - Name of file containing sub-structural input parameters (quoted string)	
